...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One comment:', '%1$s comments: ', get_comments_number(), 'comments title', 'v2starry-nights' ),
...
<!--                    <nav id="comment-nav-below" class="comment-navigation clear" role="navigation">
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'v2starry-nights' ); ?></p>
	<?php endif; ?>
