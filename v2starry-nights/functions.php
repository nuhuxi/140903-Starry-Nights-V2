...
function v2starry_nights_scripts() {
	wp_enqueue_style( 'v2starry-nights-style', get_stylesheet_uri() );
        ...
        if (is_page_template('page-templates/page-nosidebar.php')) {
            wp_enqueue_style( 'v2starry-nights-layout-style' , get_template_directory_uri() . '/layouts/no-sidebar.css');
        } else {
            wp_enqueue_style( 'v2starry-nights-layout-style' , get_template_directory_uri() . '/layouts/content-sidebar.css');
        }
